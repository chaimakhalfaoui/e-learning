...
const ModifierEvent = () => {
    ...
    useEffect(() => {
        const fetchEventData = async () => {
            setLoadingData(true);
            try {
                const response = await axios.get(`http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/api/event/getEventById/${id}`);
                ...
                setInputs({
                    ...
                    image: null,
                    imageUrl: eventData.image?.startsWith("http") ? eventData.image : `http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/api/image/${eventData.image}`
                });
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/api/event/updateEvent/${id}`, formData, {
                headers: {

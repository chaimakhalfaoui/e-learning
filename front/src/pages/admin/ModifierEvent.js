...
const ModifierEvent = () => {
    ...
    useEffect(() => {
        const fetchEventData = async () => {
            setLoadingData(true);
            try {
                const response = await axios.get(`process.env.REACT_APP_API_URL/event/getEventById/${id}`);
                ...
                setInputs({
                    ...
                    image: null,
                    imageUrl: `process.env.REACT_APP_API_URL/image/${eventData.image}`
                });
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`process.env.REACT_APP_API_URL/event/updateEvent/${id}`, formData, {
                headers: {

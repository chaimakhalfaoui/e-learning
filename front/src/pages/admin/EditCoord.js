...
const EditCoord = () => {
    ...
    useEffect(() => {
        const fetchCoordinateur = async () => {
            setLoading(true);
            try {
                const response = await axios.get(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/coordinateurs/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/coordinateurs/${id}`, inputs);

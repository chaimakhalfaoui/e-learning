...
const CreateCoord = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (inputs.username.length < 3) {
            ...
            setLoading(false);
            toast.error("Nom d'utilisateur trop court", { autoClose: 3000 });
            return;
        }
        ...
        try {
            ...
            const errorMessage = err.response?.data || "Erreur lors de la création du coordinateur";
            setErr(errorMessage);
    ...
    return (
        <React.Fragment>
            <Helmet>
                ...
                <title>Créer Coordinateur | ISETSO</title>
            </Helmet>
            <OffWrap />
            <Header
                parentMenu='pages'
            ...
            <SiteBreadcrumb
                pageTitle="Créer Coordinateur"
                pageName="Créer Coordinateur"
                    ...
                    <div style={formContainerStyle}>
                        <div className="sec-title text-center mb-30">
                            ...
                            <p className="desc" style={{ color: '#666' }}>
                                Remplissez le formulaire pour ajouter un nouveau coordinateur
                            </p>
                        </div>

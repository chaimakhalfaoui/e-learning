...
const CreateEvt = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get("http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/categorie");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post("http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/event/createEvent", formData, {
                headers: {

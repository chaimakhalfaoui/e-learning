...
const CreateEvt = () => {
    ...
    // Vérification des droits d'accès (enseignant ou admin)
    useEffect(() => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get("http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/api/categorie");
    ...
    const handleSubmit = async (e) => {
        ...
        if (!inputs.image) {
            setErr("Veuillez sélectionner une image pour l'événement.");
            setLoading(false);
        ...
        try {
            ...
            await axios.post("http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/api/event/createEvent", formData, {
                headers: {
            ...
            const errorMessage = err.response?.data || "Une erreur s'est produite lors de la création de l'événement.";
            setErr(errorMessage);
    ...
    return (
        <React.Fragment>
            <Helmet>
                ...
                <title>Créer Événement | ISETSO</title>
            </Helmet>
            <OffWrap />
            <Header
                parentMenu='event'
                    ...
                    <div className="register-box" style={{ maxWidth: "600px", margin: "0 auto" }}>
                        <div className="sec-title text-center mb-30">
                            <h2 className="title mb-10">
                                <i className="fas fa-calendar-plus me-2" style={{ color: '#ff5421' }}></i>
                                Créer un Événement
                            </h2>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="row clearfix">
                                    ...
                                    <div className="form-group col-lg-12 mb-25">
                                        ...
                                        {loadingCategories && (
                                            <small style={{ color: '#999' }}>Chargement des catégories...</small>
                                        )}
                                    </div>

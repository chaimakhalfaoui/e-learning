...
const Edu = () => {
    ...
    const fetchAllStudents = async () => {
        try {
            const response = await axios.get('http://isetso-backend-lb-617645434.us-east-1.elb.amazonaws.com/api/auth/getAllStudents');
            ...
            <div id="rs-team" className="rs-team style1 inner-style orange-style pt-102 pb-110 md-pt-64 md-pb-70 gray-bg">
                <div className="container">
                    ...
                    {Students.map((Student, index) => (
                        ...
                        <SingleTeam
                            itemClass="team-item"
                            Image={Student.image ? (Student.image.startsWith("http") ? Student.image : `http://isetso-backend-lb-617645434.us-east-1.elb.amazonaws.com/api/image/${Student.image}`) : getRandomImage()}

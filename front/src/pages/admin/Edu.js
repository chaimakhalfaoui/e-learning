...
const Edu = () => {
    ...
    const fetchAllStudents = async () => {
        try {
            const response = await axios.get('process.env.REACT_APP_API_URL/auth/getAllStudents');
            ...
            <div id="rs-team" className="rs-team style1 inner-style orange-style pt-102 pb-110 md-pt-64 md-pb-70 gray-bg">
                <div className="container">
                    ...
                    {Students.map((Student, index) => (
                        ...
                        <SingleTeam
                            itemClass="team-item"
                            Image={Student.image ? `process.env.REACT_APP_API_URL/image/${Student.image}` : getRandomImage()}

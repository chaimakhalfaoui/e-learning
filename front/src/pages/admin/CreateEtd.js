...
const CreateEtd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const errorMessage = err.response?.data || "Erreur lors de la création de l'étudiant";
            setErr(errorMessage);
    ...
    return (
        <React.Fragment>
            <Helmet>
                ...
                <title>Créer Étudiant | ISETSO</title>
            </Helmet>
            <OffWrap />
            <Header
                parentMenu='pages'
            ...
            <SiteBreadcrumb
                pageTitle="Créer Étudiant"
                pageName="Créer Étudiant"

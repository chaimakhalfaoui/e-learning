...
const EditEns = () => {
    ...
    useEffect(() => {
        const fetchEnseignant = async () => {
            setLoading(true);
            try {
                const response = await axios.get(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/enseignants/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/enseignants/${id}`, inputs);

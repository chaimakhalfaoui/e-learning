...
const Ens = () => {
    ...
    const fetchAllTeachers = async () => {
        try {
            const response = await axios.get('http://localhost:8801/api/auth/getAllTeachers');
                ...
                <div className="container">
                    ...
                    {teachers.map((teacher, index) => (
                        <div key={index} className="col-lg-4 col-md-6 mb-30">
                            <SingleTeam
                                itemClass="team-item"
                                Image={teacher.image ? `http://localhost:8801/api/image/${teacher.image}` : getRandomImage()}

...
const Ens = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                const response = await axios.get(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/auth/checkUserRoleA/${userId}`);
    ...
    const fetchAllTeachers = async () => {
        try {
            const response = await axios.get('http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/auth/getAllTeachers');
    ...
    const handleDeleteUser = async (userId) => {
        ...
        try {
            await axios.delete(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/auth/deleteUser/${userId}`);
            fetchAllTeachers();
                ...
                <div className="container">
                    ...
                    {teachers.map((teacher, index) => (
                        <div key={index} className="col-lg-4 col-md-6 mb-30">
                            <SingleTeam
                                itemClass="team-item"
                                Image={teacher.image ? (teacher.image.startsWith("http") ? teacher.image : `http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/image/${teacher.image}`) : getRandomImage()}
                                ...
                                tel={teacher.tel}
                                genre={teacher.genre}
                                delet={() => handleDeleteUser(teacher.id)}
                            />
                        </div>
                         ))}
                    </div>

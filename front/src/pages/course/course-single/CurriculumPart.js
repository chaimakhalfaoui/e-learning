...
const CurriculumPart = () => {
    ...
    const fetchUserInfo = async () => {
        try {
            ...
            const response = await axios.get(`http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/users/${userId}`);
    ...
    const fetchTravauxByActivite = async (activiteId) => {
        try {
            const userId = await idUser();
            const response = await axios.get(`http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/travaux/getByActiviteAndEtudiant/${activiteId}/${userId}`);
            ...
            const chapitresAvecRessources = await Promise.all(
                response.data.map(async (chap, chapIndex) => {
                    try {
                        ...
                        if (userId && userId !== 0) {
                            try {
                                const avcResponse = await axios.get(`http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/avc/avc/${id}/${userId}`);
    ...
    const handleSubmitTravail = async (e) => {
        ...
        try {
            ...
            await axios.post("http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/travaux/create", formData, {
    ...
    const handleSubmitReponses = async (activiteId) => {
        ...
        try {
            const userId = await idUser();
            await axios.post("http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/reponses/create", {
            ...
            try {
                ...
                return (
                    <div>
                        ...
                        {devoirData.fichier && (
                            <a 
                                href={`http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/activite/fichier/${devoirData.fichier}`} 
                                target="_blank" 
                ...
                return (
                    <div>
                        ...
                        <video controls style={styles.modalVideo}>
                            <source src={`http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/video/${videoData.video}`} type="video/mp4" />
                        </video>
        ...
        if (ressource.type_ressource === 'video') {
            return (
                <div style={{ marginTop: '10px' }}>
                    ...
                    >
                        <source src={`http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/ressource/video/${ressource.fichier}`} type="video/mp4" />
                                                ...
                                                <div key={ressource.id}>
                                                    ...
                                                    >
                                                        ...
                                                        {isVideo ? (
                                                            ...
                                                            <a 
                                                                href={ressource.fichier?.startsWith("http") ? ressource.fichier : `http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/ressource/fichier/${ressource.fichier}`}
                                                                target="_blank"
                                                                rel="noopener noreferrer"
                                                                            ...
                                                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                                                                                <div style={{ flex: 1 }}>
                                                                                    ...
                                                                                    {travailExistant.fichier && (
                                                                                        <a href={`http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/travaux/fichier/${travailExistant.fichier}`} target="_blank" rel="noopener noreferrer" style={{ fontSize: '13px', color: '#ff5421', display: 'inline-block', marginLeft: '15px', marginTop: '8px' }}>
                                                                                            <i className="fa fa-download"></i> Télécharger
                                                                                        </a>
                                                                                    )}
                                                                                </div>

...
const EtudiantsTravaux = () => {
    ...
    const fetchActivite = async () => {
        try {
            const response = await axios.get(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/activite/getActivite/${activiteId}`);
    ...
    const fetchTravaux = async () => {
        try {
            const response = await axios.get(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/travaux/getByActivite/${activiteId}`);
    ...
    const fetchEtudiantsDuCours = async () => {
        try {
            const activiteResponse = await axios.get(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/activite/getActivite/${activiteId}`);
            ...
            const chapitreResponse = await axios.get(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/chapitre/getChapitre/${chapitreId}`);
            ...
            const response = await axios.get(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/cours/getEtudiantsByCours/${coursId}`);
    ...
    const handleNoter = async (idTravail) => {
        ...
        try {
            await axios.put(`http://isetso-alb-1947778921.us-east-1.elb.amazonaws.com/api/travaux/noter/${idTravail}`, {
                note: noteValue,

...
const Login = () => {
    ...
    const verifyCode = async e => {
        ...
        try {
            ...
            const res = await axios.post('http://localhost:8801/api/auth/verify-code', body, config);
    ...
    const resendCode = async () => {
        setLoading(true);
        try {
            await axios.post('http://localhost:8801/api/auth/resend-code', { email: userEmail });

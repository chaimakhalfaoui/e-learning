...
const Login = () => {
    ...
    const login = async e => {
        ...
        try {
            ...
            const res = await axios.post('http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/api/auth/login', body, config);
    ...
    const verifyCode = async e => {
        ...
        try {
            ...
            const res = await axios.post('http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/api/auth/verify-code', body, config);
    ...
    const resendCode = async () => {
        setLoading(true);
        try {
            await axios.post('http://isetso-backend-lb-667158618.us-east-1.elb.amazonaws.com:8801/api/api/auth/resend-code', { email: userEmail });

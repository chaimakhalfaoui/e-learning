...
const EtudiantsTravaux = () => {
    ...
    const fetchActivite = async () => {
        try {
            const response = await axios.get(`http://localhost:8801/api/activite/getActivite/${activiteId}`);
    ...
    const fetchEtudiantsDuCours = async () => {
        try {
            const activiteResponse = await axios.get(`http://localhost:8801/api/activite/getActivite/${activiteId}`);
            ...
            const chapitreResponse = await axios.get(`http://localhost:8801/api/chapitre/getChapitre/${chapitreId}`);
            ...
            const response = await axios.get(`http://localhost:8801/api/cours/getEtudiantsByCours/${coursId}`);
    ...
    const handleNoter = async (idTravail) => {
        ...
        try {
            await axios.put(`http://localhost:8801/api/travaux/noter/${idTravail}`, {
                note: noteValue,
                                        ...
                                        <div key={travail.id} className="col-md-6 mb-3">
                                            <div className="card">
                                                <div className="card-body">
                                                    ...
                                                    {travail.fichier && (
                                                        <a href={`http://localhost:8801/api/travaux/fichier/${travail.fichier}`} className="btn btn-sm btn-primary">
                                                            Télécharger
                                                        </a>
                                                    )}
                                                </div>
                                                        ...
                                                        <td style={styles.td}>
                                                            {travail && (
                                                                <div>
                                                                    ...
                                                                    {travail.fichier && (
                                                                        <a href={`http://localhost:8801/api/travaux/fichier/${travail.fichier}`} target="_blank" rel="noopener noreferrer" style={styles.downloadLink}>

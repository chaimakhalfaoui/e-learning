                ...
                <div className="container">
                    <div className="register-box">
                        <div className="sec-title text-center mb-30">
                            <h2 className="title mb-10">Créer un nouveau compte</h2>
                        </div>
                            ...
                            <form id="contact-form" onSubmit={handleSubmit}>
                                <div className="row clearfix">
                                    <div className="form-group col-lg-12 mb-25">
                                        <input type="text" id="Name" name="username" value={inputs.username} placeholder="Nom" onChange={handleChange} required />
                                    </div>
                                    <div className="form-group col-lg-12">
                                        <input type="email" id="email" name="email" value={inputs.email} placeholder="Adresse email" onChange={handleChange} required />
                                    </div>
                                    
                                    <div className="form-group col-lg-12">
                                        <input type="password" id="puser" name="password" value={inputs.password} placeholder="Mot de passe " onChange={handleChange} required />
                                    </div>
                                    <div className="form-group col-lg-12">
                                        <input type="password" id="Confirm" name="confirmPassword" value={inputs.confirmPassword} placeholder="Confirmer le mot de passe" onChange={handleChange} required />
                                    </div>
                                    ...
                                    <div className="form-group col-lg-12 col-md-12 col-sm-12 text-center">
                                        <button type="submit"  className="readon register-btn"><span className="txt">S'inscrire</span></button>
                                    </div>
                                    {err && <p>{err}</p>}
                                    <div className="form-group col-lg-12 col-md-12 col-sm-12">
                                        <div className="users">Vous avez déjà un compte ? <Link to="/login">Se connecter</Link></div>
                                    </div>
                                </div>
                            </form>
                        </div>
